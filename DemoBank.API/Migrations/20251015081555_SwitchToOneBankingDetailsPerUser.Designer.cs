...
namespace DemoBank.API.Migrations
{
    ...
    [Migration("20251015081555_SwitchToOneBankingDetailsPerUser")]
    partial class SwitchToOneBankingDetailsPerUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemoBank.Core.Models.BankingDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DemoBank.Core.Models.ClientInvestment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DemoBank.Core.Models.User", b =>
                {
                    ...
                    b.Property<int?>("PotentialInvestmentRange")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DemoBank.Core.Models.UserDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DemoBank.Core.Models.BankingDetails", b =>
                {
                    b.HasOne("DemoBank.Core.Models.User", "User")
                        ...
                        .HasForeignKey("DemoBank.Core.Models.BankingDetails", "UserId")
            ...
            modelBuilder.Entity("DemoBank.Core.Models.UserDocument", b =>
                {
                    b.HasOne("DemoBank.Core.Models.User", "Reviewer")
                        .WithMany()
